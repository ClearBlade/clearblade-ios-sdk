...
@property (strong, nonatomic) IBOutlet UISegmentedControl *operationPicker;
@property (strong, nonatomic) IBOutlet UITextField *fetchKey;
@property (strong, nonatomic) IBOutlet UITextField *fetchVal;
...
@property (strong, nonatomic) IBOutlet UITextField *removeKey;
@property (strong, nonatomic) IBOutlet UITextField *removeVal;
